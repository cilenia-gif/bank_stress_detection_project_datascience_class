...
- I used Copilot and ChatGPT for helping me with the coding of the project and receive a better understanding on how VS Code is linked with GitHub. Since I have never used GitHub before, I needed certain guidance regarding on how GitHub works and the specific commands to commit everything on to my repo. 

- ChatGPT was used to help with debugging in my codes and also when converting my markdown file of the paper to a pdf. While converting I encountered some issues, which is why the markdown file of the paper is called 'project_report_clean.md' instead of 'project_report.md'. 
